...
const title = "Laurels Fashion";
const desc =
  "Laurels Fashion developed with Next.JS. Coded by Laurels Echichinwo.";
const keywords = "Laurels Fashion, E-commerce, Laurels Echichinwo, NextJS";
