...
const ProductCategory: React.FC<Props> = ({
  ...
  return (
    <div>
      {/* ===== Head Section ===== */}
      <Header title={`${capitalizedCategory} - Laurels Fashion`} />
        ...
        <Menu.Item>
          {({ active }) => (
            <button
              ...
              className={`${
                active ? "bg-gray-100 text-gray-500" : "bg-white"
              } py-2 px-4 text-left w-full focus:outline-none whitespace-nowrap ${
                currentOrder === "sort by latest" && "bg-gray-500 text-gray-100"
              }`}
            >
              {("sort by latest")}
            </button>
          ...
          {({ active }) => (
            <button
              ...
              className={`${
                ...
                currentOrder === "sort by price" && "bg-gray-500 text-gray-100"
              }`}
            >
              {("sort by price")}
            </button>
